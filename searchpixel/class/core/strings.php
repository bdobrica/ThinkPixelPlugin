...
/**
 * Strings Class. The SearchPixel plugin uses this for encapsulating strings.
 *
...
class Strings
{
     ...
     */
    const Plugin = 'searchpixel';

    /**
     * The plugin identifier slug.
     */
    const PluginSlug = 'searchpixel';

    /**
     * The short plugin identifier slug.
     */
    const PluginShortSlug = 'searchpixel';
